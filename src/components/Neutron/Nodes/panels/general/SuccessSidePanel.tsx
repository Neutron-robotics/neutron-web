...
import { SuccessNodeSpecifics } from "@neutron-robotics/neutron-core";
...
interface SuccessSidePanelProps extends HTMLAttributes<HTMLDivElement> {
    node: VisualNode
    onComplete: () => void
}
...
export default forwardRef(SuccessSidePanel)