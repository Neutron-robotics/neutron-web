...
import { ErrorNodeSpecifics } from "@neutron-robotics/neutron-core";
...
interface ErrorSidePanelProps extends HTMLAttributes<HTMLDivElement> {
    node: VisualNode
    onComplete: () => void
}
...
export default forwardRef(ErrorSidePanel)